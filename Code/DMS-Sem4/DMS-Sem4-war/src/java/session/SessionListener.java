...
import additional.SessionManager;
...
//        Set<String> set = new HashSet();
    ...
    public static boolean isSessionValid(HttpSession session) {
        if (session == null) {
            System.out.println("isSessionValid: session is invalid");
            return false;
        }
        try {
            session.getCreationTime();
            System.out.println("isSessionValid: session is valid");
            return true;
    ...
    public static void setSessionAttribute(HttpSession session, String attrName, Object value) {
        try {
            ...
            System.out.println("setting session attribute: " + attrName + "=" + value);
